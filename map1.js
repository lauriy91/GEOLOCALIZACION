...
let myMap = L.map('myMap').setView([4.69,-74.1],6) 
...
const url = 'https://services5.arcgis.com/K90UQIB09TmTjUL8/arcgis/rest/services/%C3%8Dndice_de_Amenaza_al_cambio_clim%C3%A1tico_2017_Antioquia/FeatureServer?f=pjson'
